...
```
    ...
    ----> 4 import pandas as pd
          5 # NumPy is a library for the Python programming language, adding support for large, multi-dimensional arrays and matrices, along with a large collection of high-level mathematical functions to operate on these arrays
          6 import numpy as np


    File ~/.local/lib/python3.10/site-packages/pandas/__init__.py:16, in <module>
...
f9 = df[df['BoosterVersion']!='Falcon 1']
f9
```
...
payloadmass_mean = f9["PayloadMass"].mean()
# Replace the np.nan values with its mean value
f9["PayloadMass"].replace(np.nan, payloadmass_mean ,inplace=True)
```
